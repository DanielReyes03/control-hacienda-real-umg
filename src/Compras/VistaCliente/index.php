...
<head>
  ...
  <style>
    ...
    .card { border-radius: 15px; border: none; box-shadow: 0 8px 20px rgba(0,0,0,0.1); transition: transform 0.2s; }
    .card:hover { transform: translateY(-5px); box-shadow: 0 12px 25px rgba(0,0,0,0.15); }
    .card-title { font-weight: 600; font-size: 1.25rem; }
    .card-text { color: #555; }
    .btn-agregar { background-color: #ff7f50; color: #fff; font-weight: 600; }
    .btn-agregar:hover { background-color: #ff6333; }
    .carrito-fijo { position: fixed; top: 20px; right: 20px; z-index: 1000; }
    .input-cantidad { width: 60px; }
    .category-badge { background-color: #ffe5d0; color: #ff6333; font-weight: 600; border-radius: 12px; padding: 2px 8px; font-size: 0.8rem; }
    .header-title { font-size: 2.5rem; font-weight: 700; color: #ff7f50; }
